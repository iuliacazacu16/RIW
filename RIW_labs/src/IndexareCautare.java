...
public class IndexareCautare {
	...
	public static void writeToFileIndex(PrintWriter writerID, Map<String, Map<String,Integer>> index)
	{
	...
	public static void main(String[] args) throws IOException {	
		...
		File WD = new File("E:\\FACULTATE\\An IV\\Sem II\\RIW\\RIW_LAB2\\RootDirectory");
		...
		writeToFileIndex(writerID, indexDirect);
